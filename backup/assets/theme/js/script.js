...
(function() {
        ...
        function y(a, b, d) {
            ...
            h.contains("row") && (h.remove("row"),
                h.add("media-container-row"));
        ...
        Element.prototype.parents = function(a) {
            for (var b = [], d = this, c = void 0 !== a; null !== (d = d.parentElement); )
        ...
        Element.prototype.footerReveal = function() {
            function a() {
                !d && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999",
        ...
        l(function() {
                ...
                b(a, "[data-bg-video]").forEach(function(a) {
                    ...
                    if (b) {
                        ...
                        if (d && (/youtu\.?be/g.test(d[3]) || /vimeo/g.test(d[3])))
                                    ...
                                    if (120 === (h.naturalWidth || h.width)) {
                                        ...
                                        switch (b) {
                                            ...
                                            case "sddefault.jpg":
                                                ...
                                                break;
                                            default:
                                                m && (c.style.backgroundImage = 'url("images/no-video.jpg")',
                            ...
                            m && (c.style.backgroundImage = 'url("images/video-placeholder.jpg")',
                                c.style.display = "block")
                    }
                })
            }
            ...
            window.addEventListener("scroll", function() {
                ...
                if (r) {
                    ...
                    b ? d != r.fixed && (l ? (r.fixed = d,
                        r.elm.classList.toggle("is-fixed")) : h = setTimeout(function() {
                        r.fixed = d;
                    ...
                    var a = function() {
                        ...
                        c.forEach(function(c) {
                            var h = c.offsetHeight
                                , k = d(c);
                            (k + h >= a && k - 50 <= g || b(c)) && c.classList.contains("hidden") && (c.classList.remove("hidden"),
                                c.classList.add("animate__fadeInUp"),
                                c.classList.add("animate__delay-1s"),
                                c.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
        ...
        l(function() {
            if (!m) {
                ...
                document.querySelectorAll(".modalWindow-video > iframe").forEach(function(a) {
                    ...
                    var d = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/);
                    -1 !== b.indexOf("youtu") ? a.setAttribute("src", "https://youtube.com/embed/" + d[6] + "?rel=0&enablejsapi=1") : -1 !== b.indexOf("vimeo") && a.setAttribute("src", "https://player.vimeo.com/video/" + d[6] + "?autoplay=0&loop=0")
                });
        ...
        if (!m) {
            ...
            !w() && (v = document.querySelector("section.menu")) && (z = window.innerWidth,
            !v.querySelector(".navbar").classList.contains("collapsed") && 991 < z && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
        ...
        m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0,
            document.body.querySelectorAll(".clients").forEach(function(a) {
                a.getAttribute("data-isinit") || (A(a),
                    F(a))
            })),
        ...
        "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0,
            ...
            document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function(a) {
                a.addEventListener("click", function() {
                    ...
                    !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ? (c.classList.remove("mbri-arrow-up"),
                        c.classList.add("mbri-arrow-down")) : (c.classList.remove("mbri-arrow-down"),
        ...
        if (m) {
            if (!u)
                return;
            e(document).on("add.cards", function(a) {
                e(a.target).find(".form-with-styler").length && (a = e(a.target).find(".form-with-styler"),
                    e(a).find('select:not("[multiple]")').each(function() {
